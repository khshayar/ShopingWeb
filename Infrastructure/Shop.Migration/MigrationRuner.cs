...
namespace Shop.Migration
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"[Main] Connection String: {connectionString}");

            if (string.IsNullOrEmpty(connectionString))
            {
                Console.WriteLine("[Error] Connection string is empty. Please check appsettings.json or environment variables.");
                return;
            }
        ...
        private static void CreateDatabase(string connectionString)
        {
            ...
            Console.WriteLine($"[CreateDatabase] Connection String: {connectionString}");
